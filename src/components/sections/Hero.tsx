        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 max-w-xl">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <a
                href="#projects"
                className="inline-flex items-center rounded-md bg-gradient-to-r from-[--accent] to-[--accent-2] px-5 py-2 text-black font-semibold shadow-md hover:translate-y-[-2px] transition-transform"
              >
                View My Work
              </a>
            ...
            <div className="flex items-center gap-4 mt-6">
              <a href="https://github.com" aria-label="GitHub" className="text-[--fg] hover:text-[--accent]">
                {/* GitHub */}
              ...
              <a href="https://linkedin.com" aria-label="LinkedIn" className="text-[--fg] hover:text-[--accent]">
                {/* LinkedIn */}
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <div className="relative surface-glass p-6 rounded-2xl border border-[var(--muted-border)] shadow-soft-lg">
                ...
                <div className="bg-[rgba(0,0,0,0.35)] rounded-md p-4">
                  <div className="flex flex-wrap gap-2">
                    <span className="px-2 py-1 rounded bg-[rgba(110,231,255,0.08)] text-[--accent] text-sm">React</span>
                    <span className="px-2 py-1 rounded bg-[rgba(96,165,250,0.06)] text-[--accent-2] text-sm">Angular</span>
                    <span className="px-2 py-1 rounded bg-[rgba(110,231,255,0.06)] text-[--accent] text-sm">Next.js</span>
                    <span className="px-2 py-1 rounded bg-[rgba(110,231,255,0.06)] text-[--accent] text-sm">TypeScript</span>
